...
($\rho \ge 1$). El estudio prev\'e \emph{tres} fuentes de datos
contrastables --- te\'orico, Python y AnyLogic --- de las cuales esta \'ultima
...
trabajo) y un modelo equivalente en \textbf{AnyLogic}. La
Tabla~\ref{tab:fuentes} est\'a preparada con tres columnas de datos; la de
AnyLogic queda como marcador \texttt{(pendiente)} hasta implementar y correr
el modelo. La gu\'ia paso a paso para construirlo (diagrama
Source~$\to$~Queue~$\to$~Service~$\to$~Sink, par\'ametros, experimento Monte
Carlo de $10$ r\'eplicas y barridos de $\rho$ y $K$) est\'a documentada en
\texttt{mm1/ANYLOGIC.md}.
...
\midrule
\multirow{4}{*}{$0{,}25$}
 & $L$   & $0{,}3333$ & $0{,}3365$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $L_q$ & $0{,}0833$ & $0{,}0847$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $W$   & $1{,}3333$ & $1{,}3260$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $W_q$ & $0{,}3333$ & $0{,}3335$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
\midrule
\multirow{4}{*}{$0{,}50$}
 & $L$   & $1{,}0000$ & $1{,}0020$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $L_q$ & $0{,}5000$ & $0{,}5032$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $W$   & $2{,}0000$ & $2{,}0019$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $W_q$ & $1{,}0000$ & $1{,}0054$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
\midrule
\multirow{4}{*}{$0{,}75$}
 & $L$   & $3{,}0000$ & $2{,}9631$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $L_q$ & $2{,}2500$ & $2{,}2146$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $W$   & $4{,}0000$ & $3{,}9442$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
 & $W_q$ & $3{,}0000$ & $2{,}9473$ & (pendiente) \\ % TODO AnyLogic: completar tras implementar el modelo
\bottomrule
\end{tabular}
\caption{Comparaci\'on de las tres fuentes (te\'orico / Python / AnyLogic)
para las cargas estables. La columna AnyLogic queda pendiente de completar
tras correr el modelo descrito en \texttt{mm1/ANYLOGIC.md}.}
\label{tab:fuentes}
\end{table}
...
\begin{enumerate}
  ...
  \item Queda pendiente cargar la tercera fuente de datos (AnyLogic),
    siguiendo la gu\'ia de \texttt{mm1/ANYLOGIC.md}, para cerrar la
    comparaci\'on te\'orico / Python / AnyLogic de la
