...
aproximada, la simulaci\'on en Python y un modelo equivalente en AnyLogic
(esta \'ultima a completar). Los resultados muestran que la pol\'itica
$(20, 60)$ minimiza el costo total mensual ($121{,}71$), reproduciendo el
comportamiento esperado del ejemplo de Law.
...
modelo equivalente construido en AnyLogic. La Tabla~\ref{tab:fuentes} reúne las
tres columnas para la pol\'itica recomendada $(20, 60)$. La columna de AnyLogic
queda \textbf{pendiente} hasta implementar el modelo; la gu\'ia paso a paso para
reproducirlo se encuentra en \texttt{inventario/ANYLOGIC.md}.
...
\midrule
% TODO AnyLogic: completar tras implementar el modelo
Demanda media (u/mes) & $25{,}00$           & $25{,}00$           & (pendiente) \\
Costo de ordenar      & $\approx 90$        & $90{,}88$           & (pendiente) \\
Costo de mantenimiento& sin f\'ormula cerrada & $17{,}10$         & (pendiente) \\
Costo de faltante     & sin f\'ormula cerrada & $13{,}73$         & (pendiente) \\
Costo total mensual   & ---                 & $121{,}71$          & (pendiente) \\
\bottomrule
\end{tabular}
...
se completar\'a tras implementar el modelo siguiendo
\texttt{inventario/ANYLOGIC.md}.}
\label{tab:fuentes}
\end{table}
...
\begin{enumerate}
  ...
  \item Queda pendiente cargar los resultados de AnyLogic como tercera fuente
    de datos para completar el contraste de las tres fuentes, siguiendo la
    gu\'ia de \texttt{inventario/ANYLOGIC.md}.
\end{enumerate}
